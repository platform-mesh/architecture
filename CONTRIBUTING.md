...
To create an RFC or an ADR, create a new file in the `rfc/` or `adr/` directory respectively. The file should be named with a number and a short description of the topic. For example, `001-<name>.md`.
